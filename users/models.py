...
class Payment(models.Model):
    ...
    stripe_session_id = models.CharField(
        _("ID сессии Stripe"), max_length=255, blank=True, null=True
    )
    stripe_price_id = models.CharField(
        _("ID цены Stripe"), max_length=255, blank=True, null=True
    )
    stripe_product_id = models.CharField(
        _("ID продукта Stripe"), max_length=255, blank=True, null=True
    )
    payment_status = models.CharField(
        _("статус оплаты"), max_length=50, default="pending"
    )
